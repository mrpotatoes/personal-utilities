...
export const providerAliases = (providerHost: string): string[] => mappings.providers[providerHost].aliases

// addAlias :: Object -> String -> String
export const addAlias = (providerHost: string) => (e: string): string => (
...
export const providedFlags = (): string[] => ['pr', 'commits', 'rel'] //process.argv.slice(2, process.argv.length)
...
export const isAllowedFlag = (e: string) => allowedFlags.includes(e)
